...
NUITKA_CROSS_MODULE PyObject *impl_function_1_complex_call_helper_pos_star_list_star_dict_of___internal__( PyObject **python_pars );


NUITKA_LOCAL_MODULE PyObject *impl_function_4_get_callable_name_desc_of___internal__( PyObject **python_pars );


NUITKA_CROSS_MODULE PyObject *impl_function_2_complex_call_helper_star_dict_of___internal__( PyObject **python_pars );


NUITKA_CROSS_MODULE PyObject *impl_function_3_complex_call_helper_star_list_star_dict_of___internal__( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl_function_1_complex_call_helper_pos_star_list_star_dict_of___internal__( PyObject **python_pars )
{
...

    {
        ...
        tmp_tuple_element_1 = impl_function_4_get_callable_name_desc_of___internal__( dir_call_args );
    }
...

    {
        ...
        tmp_tuple_element_2 = impl_function_4_get_callable_name_desc_of___internal__( dir_call_args );
    }
    ...
    NUITKA_CANNOT_GET_HERE( function_1_complex_call_helper_pos_star_list_star_dict_of___internal__ );
    return NULL;
    // Return handler code:
...
NUITKA_LOCAL_MODULE PyObject *impl_function_4_get_callable_name_desc_of___internal__( PyObject **python_pars )
{
    ...
    // Return statement must have exited already.
    NUITKA_CANNOT_GET_HERE( function_4_get_callable_name_desc_of___internal__ );
    return NULL;
...
NUITKA_CROSS_MODULE PyObject *impl_function_2_complex_call_helper_star_dict_of___internal__( PyObject **python_pars )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_2_complex_call_helper_star_dict_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
...
NUITKA_CROSS_MODULE PyObject *impl_function_3_complex_call_helper_star_list_star_dict_of___internal__( PyObject **python_pars )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_3_complex_call_helper_star_list_star_dict_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
